...
class Minigal_Nano_Wp_Public {
	...
	public function __construct( $minigal_nano_wp, $version ) {
		...
		if (isset($minigal_nano_wp_filters_customize) && $minigal_nano_wp_filters_customize){
		...
		if (isset($minigal_nano_wp_filters_settings)  && $minigal_nano_wp_filters_settings){
