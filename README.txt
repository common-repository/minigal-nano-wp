...
Minigal Nano WP is based on [Thomas Rybak's](http://www.minigal.dk/minigal-nano.html) version which seems to have been abandonned in 2010.

This plugin is based on the work of [SebSauvage](https://github.com/sebsauvage/MinigalNano) who took over the project. It adds new themes and icons, use more modern html/css, updates JS libs, and wants to be more community pull-friendly for the future.
